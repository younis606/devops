pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE    = "${DOCKER_REGISTRY}/voting-app:${GIT_COMMIT}"
    ...
    stages {
        ...
        stage('Update and Commit Image Tag (GitOps)') {
            ...
            steps {
                ...
                git add .
                git commit -m "Update vote-app image to ${GIT_COMMIT}"
        ...
        stage('Raise PR for GitOps') {
            ...
            steps {
                ...
                curl -X POST \
                  ...
                  -d '{
                    "title": "Update Docker Image ${GIT_COMMIT}",
